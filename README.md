...
* ![avatar](https://github.com/cuishengxi/AutomaticPackaging-of-ipa/blob/master/开始执行shell.png)
*![avatar](https://github.com/cuishengxi/AutomaticPackaging-of-ipa/blob/master/结束shell.png)
